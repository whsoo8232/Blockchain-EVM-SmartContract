...
contract ERC20TokenName is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("ERC20TokenName", "SymbolName");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("ERC20TokenName");
        transferOwnership(msg.sender);
        mint(msg.sender, initAmount * 10**decimals());
    }
